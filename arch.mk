...
ifeq ($(ARCH),RISCV)
  ...
  CFLAGS+=-fno-builtin-printf -DUSE_M_TIME -g -march=rv32imac_zifencei_zicsr -mabi=ilp32 -mcmodel=medany -nostartfiles -DARCH_RISCV
  LDFLAGS+=-march=rv32imac_zifencei_zicsr -mabi=ilp32 -mcmodel=medany
  MATH_OBJS += ./lib/wolfssl/wolfcrypt/src/sp_c32.o
